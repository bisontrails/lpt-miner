const { makeTree, getAccountsBuf } = require('merkle-mine/client/lib/helpers.js')

module.exports = async () => {
    const accountsBuf = await getAccountsBuf('./data/QmQbvkaw5j8TFeeR7c5Cs2naDciUVq9cLWnV3iNEzE784r')
